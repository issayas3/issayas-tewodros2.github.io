...
function makeContactList() {
    ...
    return {
        ...
        findContact: function(fullName) {
            ...
            //If nothing in the for loop passes then return false
            return undefined;
        },
        removeContact: function(contact) {
            //Iterate through the contact object
            for (var i = 0; i < contacts.length; i++) {
        ...
        printAllContactNames: function() {
            //Create an output variable to hold all names in the contacts object
            var output = []; 
